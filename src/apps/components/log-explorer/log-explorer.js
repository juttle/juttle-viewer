...
class LogExplorer extends React.Component {
    ...
    _onKeyDownLogWindow(e) {
        ...
        switch(keyCode) {
            ...
            case KEY_CODES.downArrow:
                handled = true;
                if (this.state.cursorPosition !== this.props.logLines.length) {
    ...
    _goToEnd() {
        this.setState({
            cursorPosition : this.props.logLines.length,
    ...
    render() {
        ...
        let linesToShow = logLines.slice(this.state.windowStart - 1, this.state.windowStart + WINDOW_SIZE - 1)
            .map((line) => {
            ...
            <div className="log-explorer">
                ...
                <div className="form-group">
                    <input 
                        ...
                        type="text" 
                        />
                    <span className="help-block">{this.state.cursorPosition } / {logLines.length}</span>
                </div>
            </div>
        );
    }
